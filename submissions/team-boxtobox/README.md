...
Farmers have information and resources around them, but the connections between those resources are weak ,Useful information and successful practices stay local instead of becoming organized community knowledge. Farmers have no open, shared place to ask questions and discuss.
...
## Screenshots
'team-boxtobox/photos'

## How to Run (optional)
<Brief setup/run instructions if judges want to try it themselves>